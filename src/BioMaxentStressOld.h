...
public:
	...
	void run(uint64_t maxSolves = 300);
...
private:
    ...
    Lamg<NetworKit::CSRMatrix> solver;
	 ...
	 */
	inline double weightingFactor(double , index edgeId) const {
